...
class Ui_volcengineform(object):
    def setupUi(self, volcengineform):
        ...
        volcengineform.setMaximumSize(QtCore.QSize(400, 350))
        ...
        # 添加音色ID字段
        self.formLayout4 = QtWidgets.QFormLayout()
        self.formLayout4.setSizeConstraint(QtWidgets.QLayout.SetMinimumSize)
        self.formLayout4.setFormAlignment(QtCore.Qt.AlignLeading | QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter)
        self.formLayout4.setObjectName("formLayout4")
        self.label_voice = QtWidgets.QLabel(volcengineform)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_voice.sizePolicy().hasHeightForWidth())
        self.label_voice.setSizePolicy(sizePolicy)
        self.label_voice.setMinimumSize(QtCore.QSize(100, 35))
        self.label_voice.setSizeIncrement(QtCore.QSize(0, 35))
        self.label_voice.setObjectName("label_voice")
        self.formLayout4.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_voice)

        self.volcenginetts_voice = QtWidgets.QLineEdit(volcengineform)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.volcenginetts_voice.sizePolicy().hasHeightForWidth())
        self.volcenginetts_voice.setSizePolicy(sizePolicy)
        self.volcenginetts_voice.setMinimumSize(QtCore.QSize(210, 35))
        self.volcenginetts_voice.setObjectName("volcenginetts_voice")
        self.volcenginetts_voice.setPlaceholderText("BV001_streaming" if config.defaulelang != 'zh' else "例如: BV001_streaming")
        self.formLayout4.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.volcenginetts_voice)
        self.verticalLayout.addLayout(self.formLayout4)
    ...
    def retranslateUi(self, volcengineform):
        ...
        self.label_voice.setText("音色ID(可选)" if config.defaulelang == 'zh' else "Voice ID(Optional)")
