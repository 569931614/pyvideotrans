...
HearSight MVP版本为BDvideoTrans添加了两个核心能力：
...
在 `BDvideoTrans` 目录下创建 `hearsight_config.json`:
...
确保你已经通过BDvideoTrans的语音识别功能生成了SRT字幕文件。
