...
参考 HearSight 原项目的设计理念,为 BDvideoTrans 集成的 HearSight 功能添加了**段落级摘要**功能。现在每个段落都会生成一个简洁的摘要（不超过50字），便于快速了解段落核心内容。
...
| 特性 | HearSight 原项目 | BDvideoTrans 集成 |
|------|------------------|-------------------|
...
通过添加段落级摘要功能，HearSight 集成到 BDvideoTrans 的功能更加完善：
